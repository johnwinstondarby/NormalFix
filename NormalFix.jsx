...
/*
NormalFix v1.0
Read-only audit for paragraphs using the paragraph style Normal with local overrides.
The InDesign UI commonly displays this state as Normal+.
...
(function () {
    ...
    function scan() {
        ...
        try {
            ...
            refresh(doc);
            if (rows.length > 0) {
                status("Scan complete. Select a finding and click Locate, or double-click it.");
            } else {
    ...
    function findingRow(para, override) {
        ...
        return {
            ...
            finding: "Normal is applied, but local/manual formatting overrides exist.",
            action: "Locate",
            paragraph: para,
            pageRef: loc.pageRef
        };
    ...
    function unknownRow(para, override) {
        ...
        return {
            ...
            location: loc.text,
            preview: previewText(safeContents(para)),
            finding: "Normal is applied, but NormalFix could not verify override state.",
            action: "Locate",
            paragraph: para,
            pageRef: loc.pageRef
        };
    ...
    function buildUI() {
        ...
        ui.title = ui.win.add("statictext", undefined, "Normal+ Audit");
        try {
    ...
    function refresh(doc) {
        ...
        ui.summary.text = docName(doc) + "\n" +
            ...
            "    Normal paragraphs: " + counts.normalParagraphs +
